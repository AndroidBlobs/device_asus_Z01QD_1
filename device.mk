...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_effects_ZS600KL.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects_ZS600KL.xml \
...
PRODUCT_PACKAGES += \
    ...
    station_speaker_calibration.sh \
    station_spk1_amp_cal_val.sh \
    station_spk2_amp_cal_val.sh \
    systrace.sh \
    touch_cfg.sh \
    umount_apd.sh \
    umount_xrom.sh \
